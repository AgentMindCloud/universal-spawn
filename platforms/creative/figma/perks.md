# Figma perks — what this platform could offer

Wishlist for what a conformant Figma consumer SHOULD offer
to manifests that declare `platforms.figma`.
...
- **Community-file duplicate-button** — a manifest with `kind: template` and a valid `community_file` URL renders a "Duplicate to your Figma" button on any universal-spawn registry card.
