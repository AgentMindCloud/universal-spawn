# Together AI perks — what this platform could offer

Wishlist for what a conformant Together AI consumer SHOULD offer
to manifests that declare `platforms.together-ai`. Items land as the
vendor ships them.
...
- **Catalogue resolver** — consumers resolve short model ids to the full catalogue path when the input is ambiguous.
