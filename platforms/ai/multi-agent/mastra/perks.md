# Mastra perks — what this platform could offer

Wishlist for what a conformant Mastra consumer SHOULD offer
to manifests that declare `platforms.mastra`. Items land as the
vendor ships them.
