# Semantic Kernel (Microsoft) perks — what this platform could offer

Wishlist for what a conformant Semantic Kernel (Microsoft) consumer SHOULD offer
to manifests that declare `platforms.semantic-kernel`. Items land as the
vendor ships them.
