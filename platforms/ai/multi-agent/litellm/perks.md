# LiteLLM perks — what this platform could offer

Wishlist for what a conformant LiteLLM consumer SHOULD offer
to manifests that declare `platforms.litellm`. Items land as the
vendor ships them.
...
- **Model list preview** — consoles preview the routed model list with health check indicators.
