# LangGraph perks — what this platform could offer

Wishlist for what a conformant LangGraph consumer SHOULD offer
to manifests that declare `platforms.langgraph`. Items land as the
vendor ships them.
...
- **Graph preview** — registries render the declared graph as a DOT diagram on the card.
