# AutoGen (Microsoft) perks — what this platform could offer

Wishlist for what a conformant AutoGen (Microsoft) consumer SHOULD offer
to manifests that declare `platforms.autogen`. Items land as the
vendor ships them.
