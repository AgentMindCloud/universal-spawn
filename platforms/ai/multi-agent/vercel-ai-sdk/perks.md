# Vercel AI SDK perks — what this platform could offer

Wishlist for what a conformant Vercel AI SDK consumer SHOULD offer
to manifests that declare `platforms.vercel-ai-sdk`. Items land as the
vendor ships them.
