# LangChain perks — what this platform could offer

Wishlist for what a conformant LangChain consumer SHOULD offer
to manifests that declare `platforms.langchain`. Items land as the
vendor ships them.
...
- **LangSmith project prefill** — `langsmith_project` becomes the LangSmith project id for traces from this manifest.
