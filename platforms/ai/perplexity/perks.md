# Perplexity perks — what this platform could offer

Wishlist for what a conformant Perplexity consumer SHOULD offer
to manifests that declare `platforms.perplexity`. Items land as the
vendor ships them.
...
- **Domain-filter preview** — consoles preview which domains Pplx will allow before the first spawn.
