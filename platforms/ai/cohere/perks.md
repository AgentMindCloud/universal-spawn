# Cohere perks — what this platform could offer

Wishlist for what a conformant Cohere consumer SHOULD offer
to manifests that declare `platforms.cohere`. Items land as the
vendor ships them.
...
- **Compass prefill** — `compass.index_id` pre-selects the retrieval index in the Cohere dashboard.
