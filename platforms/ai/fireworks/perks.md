# Fireworks AI perks — what this platform could offer

Wishlist for what a conformant Fireworks AI consumer SHOULD offer
to manifests that declare `platforms.fireworks`. Items land as the
vendor ships them.
...
- **FireFunction hint** — `fire_function: true` signals to the console that function calling is first-class for this model.
