# Windsurf perks — what this platform could offer

Wishlist for what a conformant Windsurf consumer SHOULD offer
to manifests that declare `platforms.windsurf`. Items land as the
vendor ships them.
