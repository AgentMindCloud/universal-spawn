# Aider perks — what this platform could offer

Wishlist for what a conformant Aider consumer SHOULD offer
to manifests that declare `platforms.aider`. Items land as the
vendor ships them.
