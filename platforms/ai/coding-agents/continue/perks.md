# Continue perks — what this platform could offer

Wishlist for what a conformant Continue consumer SHOULD offer
to manifests that declare `platforms.continue`. Items land as the
vendor ships them.
