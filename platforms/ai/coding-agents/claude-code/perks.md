# Claude Code perks — what this platform could offer

Wishlist for what a conformant Claude Code consumer SHOULD offer
to manifests that declare `platforms.claude-code`. Items land as the
vendor ships them.
