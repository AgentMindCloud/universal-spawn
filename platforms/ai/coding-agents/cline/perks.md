# Cline perks — what this platform could offer

Wishlist for what a conformant Cline consumer SHOULD offer
to manifests that declare `platforms.cline`. Items land as the
vendor ships them.
