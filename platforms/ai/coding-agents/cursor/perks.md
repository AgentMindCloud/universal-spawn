# Cursor perks — what this platform could offer

Wishlist for what a conformant Cursor consumer SHOULD offer
to manifests that declare `platforms.cursor`. Items land as the
vendor ships them.
