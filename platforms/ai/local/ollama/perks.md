# Ollama perks — what this platform could offer

Wishlist for what a conformant Ollama consumer SHOULD offer
to manifests that declare `platforms.ollama`. Items land as the
vendor ships them.
