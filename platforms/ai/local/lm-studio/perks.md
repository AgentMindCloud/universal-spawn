# LM Studio perks — what this platform could offer

Wishlist for what a conformant LM Studio consumer SHOULD offer
to manifests that declare `platforms.lm-studio`. Items land as the
vendor ships them.
