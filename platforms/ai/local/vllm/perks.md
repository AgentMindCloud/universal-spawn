# vLLM perks — what this platform could offer

Wishlist for what a conformant vLLM consumer SHOULD offer
to manifests that declare `platforms.vllm`. Items land as the
vendor ships them.
