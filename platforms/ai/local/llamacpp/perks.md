# llama.cpp perks — what this platform could offer

Wishlist for what a conformant llama.cpp consumer SHOULD offer
to manifests that declare `platforms.llamacpp`. Items land as the
vendor ships them.
