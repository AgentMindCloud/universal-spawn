# Northflank perks — what this platform could offer

Wishlist for what a conformant Northflank consumer SHOULD offer
to manifests that declare `platforms.northflank`. Items land as the
vendor ships them.
