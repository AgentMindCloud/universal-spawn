# Hetzner Cloud perks — what this platform could offer

Wishlist for what a conformant Hetzner Cloud consumer SHOULD offer
to manifests that declare `platforms.hetzner`. Items land as the
vendor ships them.
