# Heroku perks — what this platform could offer

Wishlist for what a conformant Heroku consumer SHOULD offer
to manifests that declare `platforms.heroku`. Items land as the
vendor ships them.
...
- **Review-apps pairing** — a manifest that declares `platforms.heroku` and uses `safe_for_auto_spawn: false` auto-disables review-app promotion.
