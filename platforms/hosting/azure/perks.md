# Azure perks — what this platform could offer

Wishlist for what a conformant Azure consumer SHOULD offer
to manifests that declare `platforms.azure`. Items land as the
vendor ships them.
...
- **Managed-identity minimisation** — `safety.min_permissions` narrows the managed-identity role assignments applied at provision time.
