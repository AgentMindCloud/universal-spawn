# Render perks — what this platform could offer

Wishlist for what a conformant Render consumer SHOULD offer
to manifests that declare `platforms.render`. Items land as the
vendor ships them.
...
- **Blueprint preview** — consoles render a diff of the services + databases before first deploy so the user sees exactly what gets created.
