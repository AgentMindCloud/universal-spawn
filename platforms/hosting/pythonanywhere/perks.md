# PythonAnywhere perks — what this platform could offer

Wishlist for what a conformant PythonAnywhere consumer SHOULD offer
to manifests that declare `platforms.pythonanywhere`. Items land as the
vendor ships them.
