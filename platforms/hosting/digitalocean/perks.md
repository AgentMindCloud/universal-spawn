# DigitalOcean perks — what this platform could offer

Wishlist for what a conformant DigitalOcean consumer SHOULD offer
to manifests that declare `platforms.digitalocean`. Items land as the
vendor ships them.
