# Vultr perks — what this platform could offer

Wishlist for what a conformant Vultr consumer SHOULD offer
to manifests that declare `platforms.vultr`. Items land as the
vendor ships them.
