# Chrome Extension perks — what this platform could offer

Wishlist for what a conformant Chrome Extension consumer SHOULD offer
to manifests that declare `platforms.chrome-extension`.
