# Firefox Extension perks — what this platform could offer

Wishlist for what a conformant Firefox Extension consumer SHOULD offer
to manifests that declare `platforms.firefox-extension`.
